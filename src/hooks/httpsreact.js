...
//import { UsersContext } from '../../route/context/UsersContext';

export const httpsreact = () => {
    ...
    const formik_validatelogon = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            await axios.post(`${apiUrl}/logxespecial`, { values }, {
                headers: {
                    ...
                    await new Promise(resolve => {
                        setTimeout(() => {
                            ...
                            if (data.data.key == 0) {
                                ...
                                handleAfterToast(data.data.url_client, data.data.data, data.data.data_di, data.data.data_username, data.data.emailxx);
                                //window.location.href = data.data.url_client;
                            }
